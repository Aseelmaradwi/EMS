    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        <div class="logo">
          ...
          <span v-if="!sidebarCollapsed" class="logo-text">EMS Admin</span>
        </div>
        ...
        <ul class="nav-list">
          ...
          <li class="nav-item">
            <router-link to="/admin/departments" class="nav-link" active-class="active">
              <span class="nav-icon">🏢</span>
              <span v-if="!sidebarCollapsed" class="nav-text">Departments</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/admin/salaries" class="nav-link" active-class="active">
              <span class="nav-icon">💰</span>
              <span v-if="!sidebarCollapsed" class="nav-text">Salaries</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/admin/leaves" class="nav-link" active-class="active">
              <span class="nav-icon">📅</span>
              <span v-if="!sidebarCollapsed" class="nav-text">Leaves</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/admin/attendance" class="nav-link" active-class="active">
              <span class="nav-icon">⏰</span>
          ...
          <div class="header-actions">
            ...
            <div class="user-menu">
              <button class="user-menu-btn" @click="toggleUserMenu">
                ...
                <span class="user-name-small">{{ user?.name || 'Admin' }}</span>
...
const pageTitle = computed(() => {
  ...
  if (path.includes('/salaries')) return 'Salary Management'
