    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        <div class="logo">
          ...
          <span v-if="!sidebarCollapsed" class="logo-text">My Portal</span>
        </div>
        ...
        <ul class="nav-list">
          ...
          <li class="nav-item">
            <router-link to="/employee/leaves" class="nav-link" active-class="active">
              <span class="nav-icon">📅</span>
              <span v-if="!sidebarCollapsed" class="nav-text">My Leaves</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/employee/attendance" class="nav-link" active-class="active">
              <span class="nav-icon">⏰</span>
              <span v-if="!sidebarCollapsed" class="nav-text">My Attendance</span>
            </router-link>
          </li>
        </ul>
      </nav>
          ...
          <div class="header-actions">
            ...
            <div class="user-menu">
              <button class="user-menu-btn" @click="toggleUserMenu">
                ...
                <span class="user-name-small">{{ user?.name || 'Employee' }}</span>
...
const pageTitle = computed(() => {
  ...
  if (path.includes('/dashboard')) return 'My Dashboard'
  if (path.includes('/profile')) return 'My Profile'
  if (path.includes('/leaves')) return 'My Leave Requests'
